...
<Tab title="KIMI_CLI">
  ...
  Permission mode: `"default"` (manual approvals), `"plan"` (read-only planning), `"auto"` (auto-approve safe operations), or `"yolo"` (auto-approve everything)
  </ParamField>

  <ParamField path="model" type="string">
  Model to use, e.g. `"kimi-code/kimi-for-coding"`, `"kimi-code/kimi-for-coding-highspeed"`, or `"kimi-code/k3"`
  </ParamField>

  [View full documentation →](https://www.kimi.com/code/docs/en/kimi-code-cli/reference/kimi-command.html)
</Tab>
